    ...
    constructor() {
        ...
        this.innerHTML = `
              <div class="row align-items-center">               
                  ...
                  <div class="col-auto">
                      <button id="volumeBtn" class="btn btn-outline-primary"  data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true">
        ...
        this.volumeRange.classList.add("form-range");
        this.volumeRange.type = "range";

        const volumeBtn = this.querySelector('#volumeBtn');
        const popover = new Popover(volumeBtn, {
            content: this.volumeRange,
            html: true
        });
    }
}
